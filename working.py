    ...
    try:
        ...
        if bay:
            ...
            if new_fifth_G_minuto:
                 return(f"{converted_slyde}:00 to{converted_sinaw}:{new_fifth_G_minuto}")  #Functioned     10 AM to 8:50 PM

            elif new_second_G_minuto:
                  return(f"{converted_slyde}:{new_second_G_minuto}to {converted_sinaw}:00") #Functioned     10:11 AM to 8 PM

            else:
                 return(f"{converted_slyde}:00 to {converted_sinaw}:00") #Functioned /2 need i modify mali n
